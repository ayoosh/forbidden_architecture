...
LLW R5 0x0005 ;
LHW R5 0x0800 ;
# These are wierd noops
LLW R2 0x0000 ; # These are wierd noops
LHW R2 0x0000 ;
LLW R3 0x0001 ;
LLW R4 0x0004 ;
LHW R4 0x0800 ; # Weird nops ended
# Weird nops ended
...
LLW R2 0x3000 ;
LHW R2 0x00C0 ;
STORE R30 R2 0x00 ; # Do not reuse register till tic value is pushed out
# #############################
FLUSH ;
...
IM1_TICS_ALGO_TX LOAD R6 R3 0x00 ;
AND R0 R6 R5 ;
...
IM1_TICS_NPU_TX LOAD R6 R3 0x00 ;
AND R0 R6 R5 ;
